...
* Click the **Upload Image** button (your image should be in on of these formats: .jpg, .jpeg, .png, .bmp) to see the image on the App and then click **Predict** button to see predicted label at the top center of the image
<p align="center">
